...
function ViewModel() {
    ...
    self.symbols = ko.observableArray([
        ...
        {id: 'PXX.TO', text: 'Black Pearl Resources TMX', links: [
        ...
        {id: 'AOI.ST', text: 'Africa Oil OMX', links: [
        ...
        {id: 'LUC.TO', text: 'Lucara Diamonds Corp', links: [
                {text: 'Avanza OMX', link: 'https://www.avanza.se/aktier/om-aktien.html/325050/lucara-diamond-corp'},
                {text: 'Avanza TMX', link: 'https://www.avanza.se/aktier/om-aktien.html/311297/lucara-diamond-corp'},
                ...
                {text: 'Stockhouse', link: 'http://www.stockhouse.com/companies/bullboard/t.luc/lucara-diamond-corp'},
                {text: 'Big Charts Canada', link: 'http://bigcharts.marketwatch.com/kaavio.Webhost/charts/big.chart?type=64&size=4&state=9&style=380&freq=5mi&time=1day&symb=ca:luc'}
            ]},
